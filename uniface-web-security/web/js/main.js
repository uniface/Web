    ...
    app.menuInstance.activate("navigationShowScreen", resourceName).then(function(){
      ...
      if (instance === null) {
        ...
        uniface.createInstance(
          ...
          console.log(e); //Log the error out to the console
        });
        ...
        //We already have this instance loaded. If we've been asked to, call the refresh operations, otherwise run the setup operations
        if (refreshPage) {
